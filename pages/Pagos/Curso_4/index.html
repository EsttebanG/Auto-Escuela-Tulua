...
<head>
    ...
    <meta charset="UTF-8">
    <title>Página de Pagos - Auto Escuela Tuluá</title>
</head>
...
<body>
    ...
    <section>
        <h2>Pago del Curso - Automovil y moto <p></p> B1 y A1 o B1 y A2</h2>
        <div class="producto">
            <p>Resumen de la compra:</p>
            <h2>Automovil y moto - B1 y A1 o B1 y A2</h2>
            ...
            <form action="#" method="post">
                ...
                <input type="text" id="total" name="total" value="$ 1.588.000" readonly><br><br>
                <p>Medios de Pago</p>
