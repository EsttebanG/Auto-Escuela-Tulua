...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a class="boton" href="sedes.html">Sedes</a></li>
            <li><a class="boton" href="inicioSeccion.html">Iniciar Sesión</a></li>
            <li><a class="boton" href="registro.html">Registrarse</a></li>
        </ul>
    </nav>
    <section>
        ...
        <div class="user-info">
            <div class="user-profile">
                <img id="user-image" src="img/default-profile.png" alt="Foto de Perfil">
