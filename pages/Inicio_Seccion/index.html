...
<body>
    ...
    <a href="https://wa.me/123456789" target="_blank">
        <img id="botonWhatsApp" src="img/LOGO WHATSAPP.png" alt="Botón de WhatsApp">
    </a>
    <section>
        <form action="usuarios.html" method="POST" class="formulario">
            <div class="campo">
        ...
        <nav>
            <ul>
                ...
                <li><a class="boton" href="/Auto-Escuela-Tulua/registro">Registrarse</a></li>
            </ul>
        </nav>
    </section>
    <footer>
