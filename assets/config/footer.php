<footer class="bg-dark">
    <div class="container-fluid text-light">
        <div class="row d-flex pt-lg-3">
            <div class="col-lg-4 col-ss-5">
                <div class="d-flex justify-content-center align-items-center ">
                    <img class="mx-auto" id="Iconte" src="/Auto-Escuela-Tulua/img/Iconte.png" alt="Iconte">
                    <img class="mx-auto" id="VigiladoSuperTransporte" src="/Auto-Escuela-Tulua/img/VigiladoSuperTransporte.png" alt="VigiladoSuperTransporte">
                </div>
                <div class="d-flex justify-content-center align-items-center">
            ...
            <div class="col-lg-4 col-ss-5 d-flex justify-content-center align-items-center">
        ...
        <div class="row">
            <div class="text-center">
                ...
                <p>Teléfonos: <strong>Sede calle 63: <a href="tel:+57 (601) 9144499">(601) 9144499</a> </strong> | <strong> Sede Cedritos: <a href="tel:+57 (601) 9144499">(601) 9144499</a></strong></p>
            </div>
        </div>
    </div>
</footer>
